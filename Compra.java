...
public class Compra {
	...
	/**
	 * Llista les llistes alim., text., electro..
	 *
	 * TODO: Recorregut del Map sense usar lambda expression
	 * REFACT: cada FOR fa el mateix, utilitzar un métode en comptes de repetir codi
	 */
	...
	/**
	 * Es compra el producte i buida llista compra
	 *
	 * REFACT es fa referència al mètode buidarLlistes en comptes d'esborrar llistes a mà
	 */
	...
	/**
	 * Agafa el nom producte mitjançant el codi de barres
	 *
	 * @param codib string
	 * @return nom
	 */
	...
	/**
	 * Compara preus producte 1 i producte 2
	 *
